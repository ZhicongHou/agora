...
class TeacherAgora{
    constructor(appid,roomNum,secId){
        this.secId=secId;
        this.appid=appid;
        this.client;
        this.localStream;
    ...
    join() {
        ...
        this.client.init(this.appid, function () {
            ...
            teacherAgora.client.join(channel_key,teacherAgora.room,teacherAgora.room, function () {
    ...
    createStream(){
        ...
        this.localStream.on("accessAllowed", function() {
            ...
            teacherAgora.localStream.setScreenProfile("1080p_1");
        });
        ...
        this.localStream.init(function() {
            ...
            teacherAgora.client.on('stream-published', function (evt) {
                ...
                $.ajax({
                    ...
                    data: {secId:teacherAgora.secId,inClass : true},
                    dataType: "json",
                    async:true,
            ...
            teacherAgora.client.on("stream-removed", function(evt) {
                var stream = evt.stream;
                if(stream.getId()===teacherAgora.room){
                    $.ajax({
                        type: "post",
                        url: "/updateInClassBySecId",
